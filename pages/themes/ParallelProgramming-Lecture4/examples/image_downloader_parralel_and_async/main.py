...
if __name__=='__main__':
	...
	# download_method = 'download_all_threadpool_executor'
	# download_time = img_downloader.measure_execution_time(download_method)
	# print(f'{download_method} time: {download_time}')
